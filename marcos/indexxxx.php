...
foreach($resultvideo as $videos) :?>		
                ...
                <p class="lead">
                    by <a href="index.php">Tiaguinho Hornet</a>
                </p>
                <p><span class="glyphicon glyphicon-time"></span> Publicado em 28 de Fevereiro de 2016 as 19:56</p>
               
                <iframe style="max-width:100%;" width="560" height="315" src="https://www.youtube.com/embed/LyxK2n2UzXY" frameborder="0" allowfullscreen></iframe>
                <br>
                <p><?=$videos->descricao?></p>
                <a class="btn btn-primary" href="#">Assistir Vídeo <span class="glyphicon glyphicon-chevron-right"></span></a>
